...
namespace NutricareApp.Web.Models
{
    public class CreateNutritionistModel
    {
        ...
        [StringLength(16, ErrorMessage = "El username del cliente debe tener de 6 a 16 caracteres")]
        public string Username { get; set; }

        [Required(ErrorMessage = "Debe incluir la contraseña del cliente")]
        [StringLength(60, ErrorMessage = "La contraseña del cliente debe tener 60 caracteres")]
